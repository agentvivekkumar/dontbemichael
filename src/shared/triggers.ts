...
export const CLONE_NODE_BLURB =
  'Set an organisation key and your teammates can message your office (the copy of '
  + 'Don\'t Be Michael running on your machine). Each teammate runs their own, so an org key '
