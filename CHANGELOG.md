...
Don't Be Michael keeps its own version line, starting at 0.0.1. Everything below the 0.0.1 entry
is the history of Munder Difflin, the open source project it is built on, kept for credit.
